...
def show_ps(lista):
    ...
    if len(secventa_pp) != 0:
        ...
        print(
            f'Cea mai lunga secventa cu proprietatea ca toate numerle sunt patrate perfecte este: {secventa_pp_str}')
    else:
...
def show_div(lista):
    ...
    if len(secventa_div) != 0:
        ...
        print(
            f'Cea mai lunga secventa cu proprietatea ca toate numerle au acelasi numar divizori este: {secventa_div_str}')
    else:
...
def menu():
    ...
    3. Determinarea celei mai lungi secvente cu proprietatea ca toate numerle au acelasi numar de divizori
    x. Inchide aplicatia
    ''')
    lista_numere = []
